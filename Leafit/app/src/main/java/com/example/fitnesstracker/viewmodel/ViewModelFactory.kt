...
class ViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T = when {
        modelClass.isAssignableFrom(HomeViewModel::class.java) ->
            HomeViewModel(application, userRepo, waterRepo, workoutRepo, sleepRepo, achieveRepo) as T
        modelClass.isAssignableFrom(WorkoutViewModel::class.java) ->
            WorkoutViewModel(application, workoutRepo, userRepo, achieveRepo) as T
        modelClass.isAssignableFrom(NutritionViewModel::class.java) ->
            NutritionViewModel(mealRepo, userRepo, achieveRepo) as T
        modelClass.isAssignableFrom(SleepViewModel::class.java) ->
            SleepViewModel(sleepRepo, achieveRepo) as T
        modelClass.isAssignableFrom(SettingsViewModel::class.java) ->
            SettingsViewModel(userRepo, achieveRepo, workoutRepo, mealRepo, sleepRepo, waterRepo) as T
