...
/**
 * «Жива» вода: дві анімовані напівпрозорі хвилі,
 * що заповнюють фон знизу пропорційно прогресу.
 */
@Composable
fun WaterWave(progress: Float, color: Color, modifier: Modifier = Modifier) {
    val infinite = rememberInfiniteTransition(label = "waterWave")
    ...
    Canvas(modifier) {
        ...
        // 0.9 — щоб гребінь хвилі не виходив за верхній край картки
